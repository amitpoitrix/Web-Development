...
// Dynamic Page access using Express Routing Parameters
app.get("/post/:topic", function(req, res) {
  // Converting the string to lowerCase using lodash
  const requestedTitle = _.lowerCase(req.params.topic);
  // For Loop to check if title exist in post or not
